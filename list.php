        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between mb-8">
                <div>
                    ...
                    <div>
                        <a href="form-insert.php" class="inline-block px-3 py-1.5 mt-10 bg-amber-500 text-amber-950 font-semibold rounded-xl hover:bg-amber-600 transition-all duration-300 shadow-sm">
